...
export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:$ENGINEAI_ROBOTICS_THIRD_PARTY/lib:$ENGINEAI_ROBOTICS_HARDWARE/lib:$ENGINEAI_ROBOTICS_DIR/core/lib:$ENGINEAI_ROBOTICS_DIR/build/_install/lib:$ENGINEAI_ROBOTICS_DIR/simulation/mujoco/build/src/lcm_interface"
